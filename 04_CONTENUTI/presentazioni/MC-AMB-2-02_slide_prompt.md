# Prompt slide deck NotebookLM — MC-AMB-2-02

**MC:** Impianti domestici e risparmio energetico
**Area:** 🏗️ Abitazione · Città · Territorio · Classe 2ª · Palette #00695C / #E0F2F1
**Fonte da caricare nel notebook:** `08_TESTI/classe_2/AMB/MC-AMB-2-02_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-AMB-2-02_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 2ª, sulla micro-competenza «Impianti domestici e risparmio energetico» (MC-AMB-2-02).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-AMB-2-02.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Una casa non è solo muri e tetto. È un sistema di impianti»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Una casa non è solo muri e tetto. È un sistema di impianti» — un solo concetto, UN esempio concreto
3. «L'impianto elettrico — dal palo dell'ENEL alla presa della tua stanza» — un solo concetto, UN esempio concreto · callout suggeriti: reti di trasmissione / cabine primarie / cabine secondarie
4. «L'impianto idraulico — dall'acquedotto allo scarico» — un solo concetto, UN esempio concreto · callout suggeriti: captazione / potabilizzazione / distribuzione
5. «L'impianto del gas — dal metanodotto al fornello» — un solo concetto, UN esempio concreto · callout suggeriti: contatori del gas / metri cubi (m³ / Utilizzi del gas in casa
6. «L'impianto di riscaldamento — dal termostato al radiatore» — un solo concetto, UN esempio concreto · callout suggeriti: caldaia / radiatori / termostato
7. «Il fotovoltaico domestico — produrre energia dal tetto» — un solo concetto, UN esempio concreto · callout suggeriti: sistema fotovoltaico domestico / 6-10 pannelli fotovoltaici / inverter
...
```bash
notebooklm create "TecnologIA — MC-AMB-2-02"
notebooklm source add "08_TESTI/classe_2/AMB/MC-AMB-2-02_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-AMB-2-02_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-AMB-2-02_deck.pptx --format pptx
```
