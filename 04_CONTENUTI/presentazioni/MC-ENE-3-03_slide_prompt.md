# Prompt slide deck NotebookLM — MC-ENE-3-03

**MC:** Fonti rinnovabili e transizione energetica
**Area:** ⚡ Energia e Macchine · Classe 3ª · Palette #E65100 / #FFF3E0
**Fonte da caricare nel notebook:** `08_TESTI/classe_3/ENE/MC-ENE-3-03_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-ENE-3-03_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 3ª, sulla micro-competenza «Fonti rinnovabili e transizione energetica» (MC-ENE-3-03).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-ENE-3-03.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Cosa rende rinnovabile una fonte di energia»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Cosa rende rinnovabile una fonte di energia» — un solo concetto, UN esempio concreto · callout suggeriti: rinnovabile / solare fotovoltaico / solare termico
3. «L'energia solare fotovoltaica: la luce trasformata in corrente» — un solo concetto, UN esempio concreto · callout suggeriti: fotovoltaico / effetto fotoelettrico / silicio
4. «L'energia eolica: il vento trasformato in elettricità» — un solo concetto, UN esempio concreto · callout suggeriti: aerogeneratore / cubo della velocità del vento / fattore di carico
5. «L'energia idroelettrica: l'acqua che scende» — un solo concetto, UN esempio concreto · callout suggeriti: energia idroelettrica / condotte forzate / turbina idraulica
6. «L'energia geotermica: il calore della Terra» — un solo concetto, UN esempio concreto · callout suggeriti: energia geotermica / Larderello, Toscana / pompe di calore geotermiche
7. «Biomasse e biogas: l'energia dal ciclo del carbonio» — un solo concetto, UN esempio concreto · callout suggeriti: biomasse / ciclo del carbonio rimane chiuso / biogas
...
```bash
notebooklm create "TecnologIA — MC-ENE-3-03"
notebooklm source add "08_TESTI/classe_3/ENE/MC-ENE-3-03_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-ENE-3-03_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-ENE-3-03_deck.pptx --format pptx
```
