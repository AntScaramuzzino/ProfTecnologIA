# Prompt slide deck NotebookLM — MC-ENE-3-05

**MC:** Macchine termiche e motori
**Area:** ⚡ Energia e Macchine · Classe 3ª · Palette #E65100 / #FFF3E0
**Fonte da caricare nel notebook:** `08_TESTI/classe_3/ENE/MC-ENE-3-05_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-ENE-3-05_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 3ª, sulla micro-competenza «Macchine termiche e motori» (MC-ENE-3-05).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-ENE-3-05.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Il calore è energia — ma attenzione a come la usi»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Il calore è energia — ma attenzione a come la usi» — un solo concetto, UN esempio concreto · callout suggeriti: calore è una forma di energia / entropia / Conseguenza pratica
3. «Il calore come "carburante" per un motore: il ciclo di Carnot» — un solo concetto, UN esempio concreto · callout suggeriti: T_H / T_C / Esempio pratico — motore a benzina
4. «La macchina a vapore: quando tutto cambiò» — un solo concetto, UN esempio concreto
5. «Il motore a scoppio a 4 tempi: la macchina del XX secolo» — un solo concetto, UN esempio concreto · callout suggeriti: Primo tempo — Aspirazione / Secondo tempo — Compressione / Terzo tempo — Scoppio (potenza
6. «Motore diesel vs. benzina: le differenze principali» — un solo concetto, UN esempio concreto
7. «Il motore elettrico: una fisica completamente diversa» — un solo concetto, UN esempio concreto · callout suggeriti: campo magnetico / corrente elettrica / rotore
...
```bash
notebooklm create "TecnologIA — MC-ENE-3-05"
notebooklm source add "08_TESTI/classe_3/ENE/MC-ENE-3-05_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-ENE-3-05_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-ENE-3-05_deck.pptx --format pptx
```
