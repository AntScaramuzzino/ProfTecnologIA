# Prompt slide deck NotebookLM — MC-ALI-2-03

**MC:** Educazione alimentare e stili di vita
**Area:** 🌾 Alimentazione · Classe 2ª · Palette #558B2F / #F1F8E9
**Fonte da caricare nel notebook:** `08_TESTI/classe_2/ALI/MC-ALI-2-03_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-ALI-2-03_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 2ª, sulla micro-competenza «Educazione alimentare e stili di vita» (MC-ALI-2-03).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-ALI-2-03.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Mangiare è chimica — e la tecnologia la controlla»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Mangiare è chimica — e la tecnologia la controlla» — un solo concetto, UN esempio concreto · callout suggeriti: chimica e biologia applicata / nutrienti
3. «I macronutrienti: cosa sono, dove si trovano, cosa fanno» — un solo concetto, UN esempio concreto · callout suggeriti: Carboidrati semplici / Carboidrati complessi / aminoacidi
4. «I micronutrienti: piccole quantità, effetti enormi» — un solo concetto, UN esempio concreto · callout suggeriti: Idrosolubili / scorbuto / Liposolubili
5. «La piramide alimentare: storia, versioni e critiche» — un solo concetto, UN esempio concreto · callout suggeriti: piramide alimentare / piramide della dieta mediterranea / Base
6. «La dieta mediterranea: patrimonio UNESCO e scienza» — un solo concetto, UN esempio concreto · callout suggeriti: UNESCO / Studio PREDIMED
7. «Diete speciali: quando il cibo è anche medicina» — un solo concetto, UN esempio concreto · callout suggeriti: Celiachia / glutine / Diabete mellito di tipo 2
...
```bash
notebooklm create "TecnologIA — MC-ALI-2-03"
notebooklm source add "08_TESTI/classe_2/ALI/MC-ALI-2-03_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-ALI-2-03_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-ALI-2-03_deck.pptx --format pptx
```
