# Prompt slide deck NotebookLM — MC-DIG-3-04

**MC:** Accessibilità, usabilità e inclusione digitale
**Area:** 💻 Digitale / Coding / AI · Classe 3ª · Palette #006064 / #E0F7FA
**Fonte da caricare nel notebook:** `08_TESTI/classe_3/DIG/MC-DIG-3-04_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-DIG-3-04_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 3ª, sulla micro-competenza «Accessibilità, usabilità e inclusione digitale» (MC-DIG-3-04).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-DIG-3-04.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Accessibilità digitale: cos'è e perché esiste»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Accessibilità digitale: cos'è e perché esiste» — un solo concetto, UN esempio concreto · callout suggeriti: accessibilità digitale / WCAG
3. «I quattro principi WCAG» — un solo concetto, UN esempio concreto · callout suggeriti: POUR / P — Percepibile (Perceivable / testo alternativo
4. «Chi beneficia dell'accessibilità» — un solo concetto, UN esempio concreto · callout suggeriti: Universal Design / Chi beneficia concretamente / 2,2 miliardi
5. «Gli strumenti per testare l'accessibilità» — un solo concetto, UN esempio concreto · callout suggeriti: WAVE (wave.webaim.org / Lighthouse di Chrome / Simulatori di daltonismo
6. «Accessibilità come obbligo legale» — un solo concetto, UN esempio concreto · callout suggeriti: Legge Stanca (L. 4/2004 / Direttiva 2016/2102 / 2 milioni
7. «Universal Design: progettare per tutti dall'inizio, non adattare dopo» — un solo concetto, UN esempio concreto
...
```bash
notebooklm create "TecnologIA — MC-DIG-3-04"
notebooklm source add "08_TESTI/classe_3/DIG/MC-DIG-3-04_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-DIG-3-04_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-DIG-3-04_deck.pptx --format pptx
```
