# Prompt slide deck NotebookLM — MC-SIS-3-03

**MC:** Imprenditorialità e innovazione tecnologica
**Area:** ⚙️ Sistemi · Economia · Lavoro · Classe 3ª · Palette #4527A0 / #EDE7F6
**Fonte da caricare nel notebook:** `08_TESTI/classe_3/SIS/MC-SIS-3-03_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-SIS-3-03_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 3ª, sulla micro-competenza «Imprenditorialità e innovazione tecnologica» (MC-SIS-3-03).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-SIS-3-03.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Cos'è un'impresa»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Cos'è un'impresa» — un solo concetto, UN esempio concreto · callout suggeriti: problema reale
3. «Le forme giuridiche di un'impresa» — un solo concetto, UN esempio concreto · callout suggeriti: Ditta individuale / Cooperativa / Startup innovativa
4. «Il Business Model Canvas» — un solo concetto, UN esempio concreto · callout suggeriti: Business Model Canvas / 1. Segmenti di clienti / 2. Proposta di valore
5. «Il metodo Lean Startup» — un solo concetto, UN esempio concreto · callout suggeriti: Lean Startup / Build-Measure-Learn / Build (Costruisci) — MVP
6. «Le fonti di finanziamento» — un solo concetto, UN esempio concreto · callout suggeriti: Bootstrap (autofinanziamento / Crowdfunding / Business angel
7. «Imprenditoria sociale: creare valore per la comunità» — un solo concetto, UN esempio concreto · callout suggeriti: imprenditoria sociale / Cooperativa sociale / Impresa benefit
...
```bash
notebooklm create "TecnologIA — MC-SIS-3-03"
notebooklm source add "08_TESTI/classe_3/SIS/MC-SIS-3-03_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-SIS-3-03_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-SIS-3-03_deck.pptx --format pptx
```
