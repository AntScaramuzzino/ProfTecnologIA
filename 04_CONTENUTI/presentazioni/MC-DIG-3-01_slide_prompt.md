# Prompt slide deck NotebookLM — MC-DIG-3-01

**MC:** Robotica educativa e pensiero computazionale avanzato
**Area:** 💻 Digitale / Coding / AI · Classe 3ª · Palette #006064 / #E0F7FA
**Fonte da caricare nel notebook:** `08_TESTI/classe_3/DIG/MC-DIG-3-01_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-DIG-3-01_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 3ª, sulla micro-competenza «Robotica educativa e pensiero computazionale avanzato» (MC-DIG-3-01).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-DIG-3-01.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Pensiero computazionale avanzato: oltre le istruzioni semplici»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Pensiero computazionale avanzato: oltre le istruzioni semplici» — un solo concetto, UN esempio concreto · callout suggeriti: Decomposizione / Riconoscimento di pattern / Astrazione
3. «Robot educativi: tre strumenti, tre filosofie» — un solo concetto, UN esempio concreto · callout suggeriti: LEGO Mindstorms EV3 (LEGO, 2013 / Arduino Uno (Arduino LLC, 2005
4. «Sensori e attuatori: gli organi di senso e i muscoli del robot» — un solo concetto, UN esempio concreto · callout suggeriti: Sensori — gli organi di senso / Attuatori — i muscoli / 80°C
5. «Programmazione event-driven: il robot che risponde» — un solo concetto, UN esempio concreto · callout suggeriti: event-driven / Evento principale (loop continuo / Evento 1
6. «Debugging come competenza: trovare gli errori in modo sistematico» — un solo concetto, UN esempio concreto · callout suggeriti: debugging / Strategie sistematiche di debugging / 1. Riproduci il bug
7. «L'intelligenza dei robot: programmato vs. apprendimento» — un solo concetto, UN esempio concreto · callout suggeriti: 30°C
...
```bash
notebooklm create "TecnologIA — MC-DIG-3-01"
notebooklm source add "08_TESTI/classe_3/DIG/MC-DIG-3-01_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-DIG-3-01_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-DIG-3-01_deck.pptx --format pptx
```
