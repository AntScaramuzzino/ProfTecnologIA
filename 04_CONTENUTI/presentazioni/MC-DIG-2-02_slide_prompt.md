# Prompt slide deck NotebookLM — MC-DIG-2-02

**MC:** Dati, privacy e identità digitale
**Area:** 💻 Digitale / Coding / AI · Classe 2ª · Palette #006064 / #E0F7FA
**Fonte da caricare nel notebook:** `08_TESTI/classe_2/DIG/MC-DIG-2-02_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-DIG-2-02_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 2ª, sulla micro-competenza «Dati, privacy e identità digitale» (MC-DIG-2-02).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-DIG-2-02.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Cos'è un dato personale — e perché sembra ovvio ma non lo è»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Cos'è un dato personale — e perché sembra ovvio ma non lo è» — un solo concetto, UN esempio concreto · callout suggeriti: Perché è importante saperlo
3. «Come vengono raccolti i tuoi dati: i meccanismi tecnici» — un solo concetto, UN esempio concreto · callout suggeriti: Cookie / Dati comportamentali
4. «Il GDPR semplificato: i tuoi diritti» — un solo concetto, UN esempio concreto · callout suggeriti: Diritto di accesso (Art. 15 / Diritto di rettifica (Art. 16 / Diritto alla portabilità (Art. 20
5. «Tracciamento online: come funziona la pubblicità personalizzata» — un solo concetto, UN esempio concreto
6. «L'impronta digitale permanente» — un solo concetto, UN esempio concreto · callout suggeriti: impronta digitale permanente / Copie e cache / Wayback Machine e archivi web
7. «Identità digitale vs identità reale» — un solo concetto, UN esempio concreto · callout suggeriti: identità reale / identità digitale
...
```bash
notebooklm create "TecnologIA — MC-DIG-2-02"
notebooklm source add "08_TESTI/classe_2/DIG/MC-DIG-2-02_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-DIG-2-02_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-DIG-2-02_deck.pptx --format pptx
```
