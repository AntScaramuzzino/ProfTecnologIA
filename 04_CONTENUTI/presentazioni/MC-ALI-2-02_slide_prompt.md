# Prompt slide deck NotebookLM — MC-ALI-2-02

**MC:** Industria alimentare e tecniche di conservazione
**Area:** 🌾 Alimentazione · Classe 2ª · Palette #558B2F / #F1F8E9
**Fonte da caricare nel notebook:** `08_TESTI/classe_2/ALI/MC-ALI-2-02_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-ALI-2-02_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 2ª, sulla micro-competenza «Industria alimentare e tecniche di conservazione» (MC-ALI-2-02).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-ALI-2-02.
...
STRUTTURA (7 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Perché il cibo si deteriora: nemici invisibili e reazioni chimiche»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Perché il cibo si deteriora: nemici invisibili e reazioni chimiche» — un solo concetto, UN esempio concreto · callout suggeriti: Causa 1: I microrganismi / tossine / Causa 2: Le reazioni enzimatiche
3. «Una breve storia della conservazione: dall'antichità alle celle frigorifere» — un solo concetto, UN esempio concreto · callout suggeriti: nomadi delle steppe centro-asiatiche / Romani / garum
4. «I metodi di conservazione moderni: principio, tecnica, prodotti» — un solo concetto, UN esempio concreto · callout suggeriti: refrigerazione / surgelazione / surgelamento rapido
5. «Come leggere un'etichetta alimentare: decodificare ciò che c'è scritto» — un solo concetto, UN esempio concreto · callout suggeriti: L'elenco degli ingredienti
6. «La catena del freddo: il viaggio del surgelato dal produttore a casa tua» — un solo concetto, UN esempio concreto · callout suggeriti: catena del freddo / 18°C
...
```bash
notebooklm create "TecnologIA — MC-ALI-2-02"
notebooklm source add "08_TESTI/classe_2/ALI/MC-ALI-2-02_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-ALI-2-02_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-ALI-2-02_deck.pptx --format pptx
```
