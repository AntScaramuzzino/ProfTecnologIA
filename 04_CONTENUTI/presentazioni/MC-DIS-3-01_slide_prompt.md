# Prompt slide deck NotebookLM — MC-DIS-3-01

**MC:** Assonometria, prospettiva e progettazione
**Area:** 📐 Disegno Tecnico · Classe 3ª · Palette #1565C0 / #E3F2FD
**Fonte da caricare nel notebook:** `08_TESTI/classe_3/DIS/MC-DIS-3-01_completa.md`
**Output:** deck fotorealistico · scaricare come **MC-DIS-3-01_deck.pptx** in `04_CONTENUTI/presentazioni/`
...
```text
Crea una presentazione didattica in ITALIANO per studenti di scuola secondaria di primo grado (11-14 anni), classe 3ª, sulla micro-competenza «Assonometria, prospettiva e progettazione» (MC-DIS-3-01).

FONTE (vincolo rigido)
- Usa ESCLUSIVAMENTE i contenuti della zona «ESPLORA» (sezione "📖 ESPLORA") del testo della MC MC-DIS-3-01.
...
STRUTTURA (8 slide)
1. COPERTINA — titolo breve e d'impatto della MC + sottotitolo di una frase che anticipa «Dal segno al volume: la sfida della rappresentazione tridimensionale»; render fotorealistico del soggetto, senza testo dentro l'immagine
2. «Dal segno al volume: la sfida della rappresentazione tridimensionale» — un solo concetto, UN esempio concreto
3. «Dal disegno tecnico al design: una storia di scelte» — un solo concetto, UN esempio concreto · callout suggeriti: design industriale / arte e tecnica non sono opposti
4. «Prospettiva centrale e prospettiva accidentale» — un solo concetto, UN esempio concreto · callout suggeriti: prospettiva / punto di fuga / linea d'orizzonte
5. «Confronto tra assonometria e prospettiva» — un solo concetto, UN esempio concreto · callout suggeriti: Regola pratica
6. «Il processo progettuale: dal brief al prodotto» — un solo concetto, UN esempio concreto · callout suggeriti: brief / Brief → Ricerca / Ricerca → Concept
7. «Design thinking: il metodo in cinque mosse» — un solo concetto, UN esempio concreto · callout suggeriti: design thinking / 1. Empatia / 2. Definizione
...
```bash
notebooklm create "TecnologIA — MC-DIS-3-01"
notebooklm source add "08_TESTI/classe_3/DIS/MC-DIS-3-01_completa.md"
notebooklm generate slide-deck "$(sed -n '/^```text$/,/^```$/p' MC-DIS-3-01_slide_prompt.md | sed '1d;$d')" --format detailed --language it
notebooklm artifact list   # attendi status=completed
notebooklm download slide-deck ./MC-DIS-3-01_deck.pptx --format pptx
```
