...
const AI_TOOLS = [
  {
    ...
    uso: "Generazione dei testi narrativi per tutte le 52 MC (⚡ INNESCA · 📖 ESPLORA · 🔍 OSSERVA · 🔬 SPERIMENTA · 🌍 AGISCI), strutturazione della matrice MC, produzione degli script hook audio, generazione dei prompt per immagini.",
    url: "https://anthropic.com",
  },
  {
    nome: "GPT Image 2 (OpenAI)",
    versione: "gpt_image_2",
    uso: "Generazione delle infografiche e immagini didattiche.",
    url: "https://openai.com",
  },
  {
    nome: "NotebookLM (Google)",
    versione: "—",
    uso: "Generazione delle infografiche e presentazioni didattiche.",
    url: "https://notebooklm.google.com",
  },
  {
    nome: "Microsoft Edge TTS (edge-tts)",
    versione: "7.2.8 · Voce: it-IT-IsabellaNeural",
    uso: "Sintesi vocale di tutti i 50 hook audio podcast (⚡ INNESCA). Generazione gratuita, voce neurale Microsoft.",
    url: "https://github.com/rany2/edge-tts",
  },
  {
    nome: "Pinecone (brain-tecnologia)",
    versione: "multilingual-e5-large · 9.879 chunk",
    uso: "Knowledge base semantica: indicizzazione di 20 libri di Tecnologia per il mercato italiano. Utilizzato per l'analisi comparata e l'allineamento editoriale alle Indicazioni Nazionali 2025.",
    url: "https://pinecone.io",
  },
  {
    nome: "Claude Code / Cowork (Anthropic)",
    versione: "—",
    uso: "Interrogazione semantica delle fonti bibliografiche in modalità batch per la costruzione della matrice MC.",
    url: "https://anthropic.com",
  },
];
