...
export const metadata: Metadata = {
  title: "Costruzione della bisettrice — Laboratorio GeoGebra",
  description: "Animazione interattiva con righello e compasso per costruire la bisettrice di un angolo.",
};

export default function AngleBisectorLaboratoryPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10">
        <div className="mb-7 max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-slate-700 sm:text-lg sm:leading-8">
            Guarda come due archi tracciati con la stessa apertura individuano un punto che divide l’angolo in due parti uguali. Poi ripeti la costruzione sul tuo foglio.
          </p>
        </div>

        <GeoGebraAngleBisectorEmbed />
        ...
        <div className="mt-7 rounded-xl border border-blue-200 bg-blue-50 p-5 text-sm leading-6 text-blue-950">
          ...
          <p className="mt-1">
            Ferma l’animazione dopo ogni passaggio e riproducilo con righello e compasso. Alla fine misura i due angoli: devono essere uguali entro un piccolo margine.
          </p>
